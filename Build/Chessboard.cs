...
{
    // Reference to the SoundEffectsPlayer
    ...
    private void Awake()
    {
        ...
        //CAMERAROTATOR SCRIPT REFERENCE
    ...
    private void Update()
    {
        ...
        if(Physics.Raycast(ray, out info, 100, LayerMask.GetMask("Tile", "Hover", "Highlight")))
        {
            ...
            if (currentlyDragging != null && Input.GetMouseButtonUp(0))
            {
                ...
                // Play sound effect for move-self (sfx1)
                soundEffectsPlayer.Src.clip = soundEffectsPlayer.sfx1;
                soundEffectsPlayer.Src.Play();
            }
        }
        else
        {
        ...
        // IF WE'RE DRAGGING A PIECE, LIFT
    ...
    private void PreventCheck()
    {
        ...
        // SINCE WERE SENDING REF AVAILABLEMOVES, WE WILL BE DELETING MOVES THAT ARE PUTTING US IN CHECK
    ...
    private void SimulateMoveForSinglePiece(ChessPiece cp, ref List<Vector2Int> moves, ChessPiece targetKing)
    {
        ...
        // GOING THROUGH ALL THE MOVES, SIMULATE THEM AND CHECK IF WERE IN CHECK
        for (int i = 0; i < moves.Count; i++)
        {
            ...
            // IS THE KING IN TROUBLE? IS SO, REMOVE THE MOVE
    ...
    private bool MoveTo(ChessPiece cp, int x, int y)
    {
            ...
            if(ocp.team == 0)
            {
                ...
                ocp.SetPosition(
                    new Vector3(8 * tileSize, yOffset, -1 * tileSize)
                     ...
                     + new Vector3(tileSize / 2, 0, tileSize / 2)
                     + (Vector3.forward * deathSpacing) * deadWhites.Count);
                    soundEffectsPlayer.Src.clip = soundEffectsPlayer.sfx4;
                    soundEffectsPlayer.Src.Play();
            }
            else
            {
        ...
        //ROTATE THE CAMERA AFTER SUCCESSFUL MOVE
